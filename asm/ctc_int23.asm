...
MAIN:
        ...
        LD      HL,ISR_CH3      ;Link CH3 Interrupter Service Routines 
        LD      (INT_HGH + INT_CH3),HL 
...
INT_CTC:
;Initilizes CH2 
;CH2 divides CPU CLK by (256*128), providing a clock signal at TO2. TO2 is connected to TRG3 
;T02 outputs f= CPU_CLK/(256*128) => 7.3728MHz / ( 256 * 128 ) => 225Hz 
...
;Initilizes CH3 
;CH3 counts TRG3 CLK clock   
;outputs f= CLK / 225 => 225Hz / 225 => 1Hz ~ 1s (pluse)
