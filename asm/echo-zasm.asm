...
BUFFHD:     EQU     0D00H  ;Pointer to the Head of the Circular buffer                      (1-byte)
BUFFTL:     EQU     0D01H  ;Pointer to the Tail of the Circular buffer                      (1-byte)
...
BUFSIZ:     EQU     BUFF32 ;32 bytes (Change if required)
