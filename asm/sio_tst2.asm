...
SIO_WV:     EQU         0E008H              ;Transmit Interrupt Vector
SIO_EV:     EQU         0E00AH              ;External Status Interrupt Vector 
SIO_RV:     EQU         0E00CH              ;Receive Interrupt Vector
SIO_SV:     EQU         0E00EH              ;Special Receive Interrupt Vector 
...
;CH1 provides to SIO SERIAL A the RX/TX clock
            ...
            OUT     (CTC_CH1),A
            RET                         ;TO1 output frequency=CPU_CLK/prcs/time constant = 153600 Hz 
